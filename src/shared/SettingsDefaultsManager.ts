...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_WORKER_URL: string;  // When non-empty, clients connect to this remote worker URL and no local daemon is spawned
...
export class SettingsDefaultsManager {
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_WORKER_URL: '',  // Empty = local mode (default). Set to e.g. 'http://claude-mem.local:37777' for remote worker mode.
